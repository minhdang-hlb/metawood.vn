...
class CnbLegacyUpgrade {
    ...
    private function feature_comparison_free_promobox() {
        ...
        <p style="margin-bottom: 0">When signing up you activate the NowButtons cloud features.</p>
        ...
        <div class="cnb-signup-block-fixed">
          <h3 id="cnb-sign-up-here">Sign up, it's free!</h3>
        ...
        <div class="cnb-body-column">
          ...
          <h2>Feature comparison</h2>
                ...
                <p>Sign up now to create your NowButtons account. Once you've confirmed your account via email, your Call Now Button plugin is automatically upgraded to <b><?php echo esc_html(CNB_CLOUD_NAME) ?></b>.</p>
        </div>
    <?php }
